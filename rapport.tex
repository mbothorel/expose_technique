...
Comme nous l'avons vu, Vagrant est un logiciel très complet. Il permet de créer, de partager et d'utilisé une machine virtuelle. Il est possible de configurer finement ces machines. De plus, malgré quelques 
