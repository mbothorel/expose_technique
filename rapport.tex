...
Vagrant est dans les dépôts de Debian unstable en version 1.6.5, et est disponnible en version 1.7.2 sur le site officiel. Nous avons essayé la version 1.6.2 et 1.7.2. Le projet Fedora ne supporte pas encore Vagrant. Malgré cela, ils souhaitent le proposer pour la version 22 avec le logiciel libvirt comme hyperviseur par défaut, au lieu de VirtualBox.

On peut donc récupérer le tarball sur GitHub, le récupérer grâce aux dépôts sur Debian et ses dérivés. On peut également récupérer les paquêts Deb, RPM, les executables .msi et .dmg pour Windows et OS X sur le site officiel du projet.

Comme dit ci-dessus, nous avons utilisé la version du dépot Debian et la dernière version du site officiel.
